...
const styles = StyleSheet.create({
  ...
  tabActive: { backgroundColor: "#1A2D42" },
  tabText: { fontFamily: "Cairo_600SemiBold", fontSize: 11, color: "#6B7E91" },
  ...
  playerName: { fontFamily: "Cairo_600SemiBold", fontSize: 14, color: "#F0E6D3" },
  playerSub: { fontFamily: "Cairo_400Regular", fontSize: 11, color: "#6B7E91", marginTop: 2 },
  ...
  sentBadge: { backgroundColor: "#6B7E91" + "20", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5 },
  sentBadgeText: { fontFamily: "Cairo_400Regular", fontSize: 11, color: "#6B7E91" },
  codeBanner: {
    flexDirection: "row", alignItems: "center", justifyContent: "space-between",
    backgroundColor: "#1E3448", borderRadius: 14, marginHorizontal: 16, marginBottom: 10,
    paddingHorizontal: 14, paddingVertical: 10,
    borderWidth: 1, borderColor: Colors.gold + "30",
  },
  codeBannerLeft: { flexDirection: "row", alignItems: "center", gap: 8 },
  codeBannerLabel: { fontFamily: "Cairo_600SemiBold", fontSize: 13, color: "#A8B8CC" },
  codeBannerValue: { fontFamily: "Cairo_700Bold", fontSize: 14, color: Colors.gold },
  toast: {
    position: "absolute", top: 120, alignSelf: "center",
    flexDirection: "row", alignItems: "center", gap: 6,
    backgroundColor: "#1A2D42", borderRadius: 10,
  ...
  sectionLabel: { fontFamily: "Cairo_700Bold", fontSize: 13, color: "#A8B8CC", marginTop: 8, marginBottom: 4 },
  playSection: {
    flexDirection: "row", alignItems: "center",
    backgroundColor: "#1E3448", borderRadius: 16,
    marginHorizontal: 16, marginBottom: 12,
    borderWidth: 1, borderColor: "#2A4560", overflow: "hidden",
  },
  playBtn: {
  ...
  playDivider: { width: 1, height: 40, backgroundColor: "#2A4560" },
  searchBox: {
    flexDirection: "row", alignItems: "center",
  ...
  searchInput: { flex: 1, fontFamily: "Cairo_400Regular", fontSize: 14, color: "#F0E6D3" },
  empty: { alignItems: "center", paddingTop: 40, gap: 8 },
  emptyIcon: { fontSize: 40 },
  emptyText: { fontFamily: "Cairo_600SemiBold", fontSize: 15, color: "#A8B8CC" },
  emptySubText: { fontFamily: "Cairo_400Regular", fontSize: 13, color: "#6B7E91", textAlign: "center" },
});
