...
const styles = StyleSheet.create({
  ...
  backBtn: { width: 40, height: 40, borderRadius: 12, backgroundColor: "#12122A", justifyContent: "center", alignItems: "center", marginBottom: 20 },
  backBtnSmall: { width: 32, height: 32, borderRadius: 10, backgroundColor: "#12122A", justifyContent: "center", alignItems: "center", marginRight: 10 },
  gameTopBar: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 12, backgroundColor: "#0E0E24", borderBottomWidth: 1, borderBottomColor: "#1E1E3A" },
  ...
  roundLabel: { fontFamily: "Cairo_600SemiBold", fontSize: 12, color: "#9898CC", marginBottom: 8, textAlign: "right" },
  ...
  categoryInput: { flex: 1, backgroundColor: "#0E0E24", borderRadius: 12, borderWidth: 1, borderColor: "#1E1E3A", paddingHorizontal: 14, paddingVertical: 10, fontSize: 16, fontFamily: "Cairo_400Regular", color: "#E8E8FF" },
  ...
  gameOverTitle: { fontFamily: "Cairo_700Bold", fontSize: 32, color: "#E8E8FF", textAlign: "center", marginBottom: 20 },
  ...
  finalRankRow: { backgroundColor: "#12122A", borderRadius: 14, padding: 14, flexDirection: "row", alignItems: "center", borderWidth: 1, borderColor: "#1E1E3A" },
  finalRankRowMe: { borderColor: Colors.gold + "60" },
  finalRankNum: { fontFamily: "Cairo_700Bold", fontSize: 20, width: 36, textAlign: "center" },
  finalRankName: { flex: 1, fontFamily: "Cairo_600SemiBold", fontSize: 15, color: "#E8E8FF", paddingHorizontal: 10 },
  ...
  homeBtn: { backgroundColor: "#12122A", borderRadius: 16, minHeight: 48, justifyContent: "center", paddingHorizontal: 40, borderWidth: 1, borderColor: "#1E1E3A" },
