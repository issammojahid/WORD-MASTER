...
const PROJECT_NAME = "Huroof Al Maghrib";

const PRODUCT_IDENTIFIER = "battle_pass_premium_s1";
const PLAY_STORE_PRODUCT_IDENTIFIER = "battle_pass_premium_s1";

const PRODUCT_DISPLAY_NAME = "Battle Pass Premium Season 1";
const PRODUCT_USER_FACING_TITLE = "Battle Pass Premium Season 1";

const APP_STORE_APP_NAME = "Huroof Al Maghrib iOS";
const APP_STORE_BUNDLE_ID = "com.huroofalmaghrib";
const PLAY_STORE_APP_NAME = "Huroof Al Maghrib Android";
const PLAY_STORE_PACKAGE_NAME = "com.huroofalmaghrib";

const ENTITLEMENT_IDENTIFIER = "battle_pass_premium";
const ENTITLEMENT_DISPLAY_NAME = "Battle Pass Premium";

const OFFERING_IDENTIFIER = "default";
const OFFERING_DISPLAY_NAME = "Default Offering";

const PACKAGE_IDENTIFIER = "$rc_lifetime";
const PACKAGE_DISPLAY_NAME = "Battle Pass Premium";

const PRODUCT_PRICES = [
  { amount_micros: 1990000, currency: "USD" },
  { amount_micros: 1990000, currency: "EUR" },
  { amount_micros: 19900000, currency: "MAD" },
];
